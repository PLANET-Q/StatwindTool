            ...
            for d in days:
                ...
                for h in init_times:
                    for f in fore_times:
                        ...
                        rawcsv_output_dir = os.path.join(this_file_path, 'MSMtool/csv/JST' + str(h) + '+' + str(f) + 'h/')
                        interp_csv_output_dir = os.path.join(this_file_path, '../wind_MSM/' + interp_place + '/JST' + str(h) + '+' + str(f) + 'h/')
